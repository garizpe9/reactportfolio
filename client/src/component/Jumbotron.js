  ...
  return (
    <div>
      <Jumbotron className="home">
        ...
        I strive to enhance internal and external processes and created company guidelines on how to update software along with company instructional guides for clients to use on tax software. Moreover, I implemented proofs for Tax Analytics applications and created several applications based on the company's code library. <br/><br/>
